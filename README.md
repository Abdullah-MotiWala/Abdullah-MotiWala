...
- **Lead Software Engineer @ Takaful Bazaar** (2022 – 2025)  
  ...
  - Developed **microservices and REST APIs** serving high-traffic financial applications  

- **Associate Software Engineer @ Intelligenes** (2022)  
  - Improved backend performance by **20%** via query optimization and service-level caching  
  - Successfully delivered client-facing features with a **95% UAT success rate**  
  - Built responsive and user-friendly features for high-throughput systems  

- **Software Engineer Intern @ SMIT** (2021 – 2022)  
  - Developed in-house projects with **React.js & Node.js**, gaining hands-on full-stack experience  
  - Contributed to core features, UI design, and database integrations  
...
**Other Tools:** WebSockets, Socket.io, Stripe, Plaid, FCM, Agora, LangChain, LangGraph  
...
- **Teaching Projects** – Developed and maintained **hands-on MERN stack projects** for 150+ students at SMIT & BanoQabil  
